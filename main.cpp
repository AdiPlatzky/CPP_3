...
#include "Game.h"
#include "Player.h"
#include "Rols/Baron.h"
#include "Rols/Governor.h"
#include "Rols/Judge.h"
#include "Rols/General.h"
#include "Rols/Spy.h"
#include "Rols/Merchant.h"
#include <memory>
...
int main() {
  ...
  try {
    ...
    std::cout << "Turn: " << game.getCurrentPlayer().getName() << sts::endl << std::endl;
    ...
    player4->addCoins(10);
    std::cout << "Turn: " << game.getCurrentPlayer().getName() << sts::endl;
